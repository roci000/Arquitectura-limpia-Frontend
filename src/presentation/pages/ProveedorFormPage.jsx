...
export default function ProveedorFormPage() {
  ...
  const loadProveedor = async (proveedorId) => {
    try {
      ...
      alert('No se pudo cargar el proveedor.', err);
    ...
    <div style={{ display: 'flex', backgroundColor: '#C9F6BC', minHeight: '100vh' }}>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input id="nombre" name="nombre" value={form.nombre} onChange={handleChange} placeholder="Ej: Distribuidora ABC" required style={{ width: '100%', padding: '8px', marginBottom: '16px', border: '1px solid #ccc', borderRadius: '4px' }} />
          ...
          <input id="direccion" name="direccion" value={form.direccion} onChange={handleChange} placeholder="Ej: Av. Siempre Viva 123" required style={{ width: '100%', padding: '8px', marginBottom: '16px', border: '1px solid #ccc', borderRadius: '4px' }} />
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button type="button" onClick={() => navigate('/proveedores')} style={{ flex: 1, backgroundColor: '#f44336', color: 'white', padding: '10px 16px', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: '600' }}>
              Cancelar
            </button>
          </div>
        </form>
